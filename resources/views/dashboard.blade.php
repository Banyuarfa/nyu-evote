    ...
    <section class="relative flex h-[calc(100vh_-_72px)] flex-col bg-slate-100">
        <div class="top-10 z-40 mx-auto my-8 lg:absolute lg:left-1/2 lg:m-0 lg:-translate-x-1/2">
            <div class="flex justify-center gap-2">
                <img class="h-12 md:h-14 lg:h-16 aspect-square object-contain" src="assets/img/smkn1-logo.webp" alt="">
                <img class="h-12 md:h-14 lg:h-16 aspect-square object-contain" src="assets/img/chetana-vardhaka-sangha.png" alt="">
                <img class="h-12 md:h-14 lg:h-16 aspect-square object-contain" src="assets/img/osis-logo.png" alt="">
            </div>
